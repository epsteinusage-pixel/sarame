...
layout.Padding = UDim.new(0, 8)
        ...
        function tab:add_textbox(name, placeholder, callback)
            local layout = page:FindFirstChild("UIListLayout") or Instance.new("UIListLayout", page)
            layout.Padding = UDim.new(0, 8)
            layout.HorizontalAlignment = Enum.HorizontalAlignment.Center
            layout.VerticalAlignment = Enum.VerticalAlignment.Top
            ...
            textbox_container.Name = name .. "_Textbox"
            textbox_container.Size = UDim2.new(1, -15, 0, 38)
            textbox_container.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
            textbox_container.BorderSizePixel = 0
            textbox_container.Parent = page
        
            local container_corner = Instance.new("UICorner")
            container_corner.CornerRadius = UDim.new(0, 6)
            container_corner.Parent = textbox_container
        
            local container_stroke = Instance.new("UIStroke")
            container_stroke.Thickness = 0.5
            container_stroke.Color = Color3.fromRGB(120, 120, 120)
            container_stroke.Parent = textbox_container
            ...
            label.Font = Enum.Font.Roboto
            label.TextXAlignment = Enum.TextXAlignment.Left
            label.Parent = textbox_container
            ...
            text_box.Parent = textbox_container
